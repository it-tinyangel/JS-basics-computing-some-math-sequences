...
// arithmetic progression with initial element of 1000 and difference 3
// each subsequent element is obtained by adding 3 to the previous element
...
// arithmetic progression with initial element of 1 and difference 2
// each subsequent element is obtained by adding a 2 to the previous element
...
// arithmetic progression with initial element of 90 and a difference of - 5
// each subsequent element is obtained by subtracting 5 from the previous element
for (let a = 90; a >= 0; a += -5)
	document.write(`<h2 style="color: black">${a}</h2>`);

// 5. the first 20 elements of the sequence 2 4 8 16 32 64 128 ...
// geometric progression with initial element 2 and a doubling factor
...
// but let's use 2a - 1 as a counter change step, as written in the task condition
for (let a = 2; a < 10000; a = 2 * a - 1)
	document.write(`<h2 style="color: lightseagreen">${a}</h2>`);

// 7. all two-digit elements of the sequence 2a + 200 (the counter change step),
// where the initial value of the variable a = -166
// 2a + 200 looks like an arithmetic progression,
// but let's use 2a + 200 as a counter change step, as written in the task condition
